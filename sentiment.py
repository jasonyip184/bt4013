...
'''
# access_token = '1230653442336575489-SzpGHG9ZyHedGUbP49W8YXY6C1D1wt'
# access_token_secret = 'bnGPD6drhBFNeMXh4FSK1H3FbFHGjYi8lR9tNfPvZjnpO'
# consumer_key = 'qTFpNOWOOf4MCsuE3MgIj1rbq'
# consumer_secret = 'svllJED8qxLUAxjpLIm5tRLMwyDAUSY3j85Q3v4UH3jkuKq9ez'
...
# with open('trump_train_dict.pickle', 'wb') as handle:
#     pickle.dump(d, handle)

'''
Train futures prices against prev day news
'''
with open('trump_train_dict.pickle', 'rb') as handle:
...
# print(df)
# with open('trump_train_data.pickle', 'wb') as handle:
